...
?>
    ...
    {
        echo "<h1>No Ride Confirmed yet\n please wait for one of your request to be accepted</h1>";
        exit();
    }
    ?>
     <?php 
        ...
        (tbl_request_ride.To-CURRENT_TIMESTAMP)-1000 As totime
        ...
        if($results->num_rows > 0)
        {
            while($row=$results->fetch_array())
            {
                ...
                else if($row["RideStatus"]=="Ride Ended")
                {
