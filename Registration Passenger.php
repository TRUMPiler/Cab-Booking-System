...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <h1 class="card-header text-center">Register as Passenger</h1>
                    <div class="card-body">
                            ...
                            <section class="registration-section" id="personal-info-section">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <span class="error errorpi" id="dob_err"> </span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <span class="error errorpi" id="address_err"> </span>
                                    </div>
                                    <div class="form-group col-md-12">
                            ...
                            <section class="registration-section" id="contact-info-section" style="display: none;">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <span class="error errorci" id="email_err"> </span>
                                    </div>
                                    <div class="form-group">
                                        <label for="contact_number">Contact number:</label>
                                        <input type="tel" class="form-control" id="contact" name="contact" required>
                                        <span class="error errorci" id="contact_err"> </span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between">
                                ...
                                $(document).ready(function() {
                                    ...
                                    $("#myform").submit(function(event) {
                                        ...
                                        if ($(".error").text().trim() !== "") {
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: "ajax_files/setpassenger.php",
                                                data: formdata,
                                                contentType: false,
                                                cache: false,
                                                processData: false,
