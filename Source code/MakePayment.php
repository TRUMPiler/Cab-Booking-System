...
<?php 
                            ...
                            if($result->num_rows > 0)
                            {
                                ...
                                {
                            ?>
                            <h1 id='razorGG'>₹<?php echo $row["Cost"]?></h1>
<script
    src="https://checkout.razorpay.com/v1/checkout.js"
    data-key="rzp_test_jeRt2IQyrN9mmp" 
    data-amount="100" 
    data-currency="INR"
    data-order_id=''
    data-buttontext="Pay ₹<?php echo $row["Cost"]?>"
    data-name="TAXDASH"
    data-description="TAXDASH"
    data-image="Images/Taxibooking.png"
